...
- (void)setupSpotlight {
    ...
    AwesomeSpotlight *logoImageViewSpotlight = [[AwesomeSpotlight alloc] initWithRect:logoImageViewSpotlightRect shape:AwesomeSpotlightShapeCircle text:@"logo Image View Spotlight" margin:logoImageViewSpotlightMargin isAllowPassTouchesThroughSpotlight:false];
    
    AwesomeSpotlight *nameLabelSpotlight = [[AwesomeSpotlight alloc] initWithRect:self.nameLabel.frame shape:AwesomeSpotlightShapeRectangle text:@"name Label Spotlight" margin:spotlightMarginDefault isAllowPassTouchesThroughSpotlight:false];
    
    AwesomeSpotlight *showButtonSpotSpotlight = [[AwesomeSpotlight alloc] initWithRect:self.showButton.frame shape:AwesomeSpotlightShapeRoundRectangle text:@"show Button Spot Spotlight" margin:spotlightMarginDefault isAllowPassTouchesThroughSpotlight:false];

    AwesomeSpotlight *showWithContinueAndSkipButtonSpotlight = [[AwesomeSpotlight alloc] initWithRect:self.showWithContinueAndSkipButton.frame shape:AwesomeSpotlightShapeRoundRectangle text:@"show With Continue\nAnd Skip Button Spotlight" margin:spotlightMarginDefault isAllowPassTouchesThroughSpotlight:false];
    
    AwesomeSpotlight *showAllAtOnceButtonSpotlight = [[AwesomeSpotlight alloc] initWithRect:self.showAllAtOnceButton.frame shape:AwesomeSpotlightShapeRoundRectangle text:@"show All At Once Button Spotlight" margin:spotlightMarginDefault isAllowPassTouchesThroughSpotlight:false];
	...
	self.spotlightView.alignment = NSTextAlignmentLeft;
